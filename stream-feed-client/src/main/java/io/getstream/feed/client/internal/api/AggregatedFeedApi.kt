...
/**
 * API to be used with Retrofit to provide Aggregated Feed Endpoints.
 */
internal interface AggregatedFeedApi : FeedApi {
    ...
    ): Response<AggregatedActivitiesGroupResponse>
